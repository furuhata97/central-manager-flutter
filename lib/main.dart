...
import 'package:estudo/screens/auth_check/auth_check.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        appBarTheme: const AppBarTheme(backgroundColor: Color(0xFF1a6ed1)),
      ...
      routes: {
        ...
        '/login': (BuildContext context) => const AuthCheck(
              routeName: '/login',
